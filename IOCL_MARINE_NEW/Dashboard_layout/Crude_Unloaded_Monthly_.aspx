<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard_layout/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="Crude_Unloaded_Monthly_.aspx.cs" Inherits="IOCL_MARINE_NEW.Dashboard_layout.Crude_Unloaded_Monthly_" %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            <h5 class="card-title">Crude Unloaded Monthly</h5>
                                                <div class="row" style="margin-bottom:24px">
                                                    <asp:HiddenField ID="lblCrudMonthlyId" Value="" runat="server" />
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                    <label for="exampleEmail" class="">MMT Monthly</label>
                                                        <asp:TextBox ID="txt_mmtmnothly"  CssClass="form-control-sm form-control num"  runat="server"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="cum" ControlToValidate="txt_mmtmnothly"  CssClass="validation_style" Display="Dynamic" runat="server" ErrorMessage="This Field Can't be blank ..."></asp:RequiredFieldValidator>
                                                      </div>
                                               ...
                                               <div class="row">
                                                    <div class="col-md-12">
                                                        <asp:GridView ID="grid_Crude_unloaded_monthly" CssClass="table table-hover table-striped table-bordered mt_top sorting_" OnRowDeleting="grid_Crude_unloaded_monthly_RowDeleting" OnRowEditing="grid_Crude_unloaded_monthly_RowEditing" OnRowCommand="grid_Crude_unloaded_monthly_RowCommand" AutoGenerateColumns="false" runat="server">
                                                            <Columns>
                                                        <asp:TemplateField HeaderText="Transaction Id" Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblid" runat="server" Text='<%# Eval("CrudMonthlyId") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="MMT Monthly">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblMmtMonthly" runat="server" Text='<%# Eval("MmtMonthly") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
