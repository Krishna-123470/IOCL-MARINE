...
using System.IO;
using System.Text;
using IOCL_MARINE_NEW.Dashboard_layout;
using System.Data;
...
namespace IOCL_MARINE_NEW.AppCode
{
    public class DAL
    {
      DB_CON db = new DB_CON();
        public DataTable getrec(string qry)
        {
        ...
        public void Db_transact(string qry)
        {
            SqlCommand cmd = new SqlCommand(qry, db.con);
            db.con.Open();
            cmd.ExecuteNonQuery();
    ...
    public class PArent_CL
    {
        public static DashboardMaster parentcl(DashboardMaster abc)
        {
            DashboardMaster mst = abc;
            return mst;
        }
